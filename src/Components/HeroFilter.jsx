    ...
    <div className="filter_container">
      ...
      <div className="filter_atts">
        ...
        <div className="filter_atts_imgs">
          <img ref={elem => imagesRef.current[0] = elem} onClick={({target})=>{filterHeroes("str", target)}}  className="filter_atts_img" src={strIcon} alt={`agiIcon`} />
          <img ref={elem => imagesRef.current[1] = elem} onClick={({target})=>{filterHeroes("agi", target)}} className="filter_atts_img" src={agiIcon} alt={`agiIcon`} />
          <img ref={elem => imagesRef.current[2] = elem} onClick={({target})=>{filterHeroes("int", target)}} className="filter_atts_img" src={intIcon} alt={`intIcon`} />
        </div>
      </div>
